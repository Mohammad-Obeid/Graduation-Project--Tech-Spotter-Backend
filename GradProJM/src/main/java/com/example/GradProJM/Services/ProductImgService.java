...
public class ProductImgService {
    ...
    public List<ProductImageData> saveImagesForProduct(List<MultipartFile> imageFiles, String shopName, String prodBarcode) throws IOException {
        ...
        Optional<Shop_Products> productOptional = prdshpRepo.findShop_ProductsByShop_ShopNameAndProduct_ProductBarcodeAndDeletedFalse(shopName, prodBarcode);
    ...
    public  List<String> getImagesForProduct(String prodBarcode, String shopName) {
        ...
        Optional<Shop_Products> product = prdshpRepo.findShop_ProductsByShop_ShopNameAndProduct_ProductBarcodeAndDeletedFalse(shopName,prodBarcode);
